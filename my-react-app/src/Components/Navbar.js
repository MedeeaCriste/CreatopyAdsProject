...
export default function Navbar() {
    return (
      <nav className=" flex flex-col lg:p-10 bg-[#FF00FF] justify-center lg:flex-row lg:justify-between gap-2 items-center">
      <h1 className="text-[#FFFFFF] text-xl lg:text-2xl">
        Cretopy project
      </h1>
      <div className=" flex-col lg:flex-row w-fit  sm:flex-row sm:mb-2  text-[#FF00FF] gap-2  text-center flex lg:gap-8  lg:justify-center lg:items-center ">
