...
<div className='flex flex-col justify-center items-center '>
        <SerachBar/>
    <div className=' border-[1px] mb-5 border-[#1e3a8a] w-[1080px] h-[1920px] flex flex-col justify-center items-center'>
...
Grain Free Dry Cat <br/>  Food | Reveal Pet Food
       ...
       <img src='/assets/photo-ads-1.webp' className='w-[200px]'/>
        ...
        <p className='mt-[200px] text-center p-1 text-white font-semibold text-md bg-[#1e3a8a]  w-[1080px]'>Best quality</p>
